...
//       y2: null,
//     };
//     //PROBLEM: Modifying one line modifies all 'future' lines. This isn't what's supposed to happen
//     //Original author was drawing lines from a node to the end, I need to draw from a node to the next node
//     svg
//       .selectAll('line')
//       .data(events)
//       .enter()
...
//         return cfg.color;
//       })
//       .attr('stroke-width', cfg.lineWidth) //Changed to an attribute to make more sense
...
//               return Math.floor(d.lineWidth);
//             }
//             return Math.floor(cfg.lineWidth);
//           });
//         tip.html('');
//         tip
//           .append('div')
